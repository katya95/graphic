...
function check_form(theForm)
{
	...
	if(theForm.top_right_x.value > theForm.bottom_left_x.value)
	{
		alert("Пожалуйста, введите top-right_x меньше, чем bottom_left_x");
	
		return (false);
	}
	if(theForm.top_right_y.value > theForm.bottom_left_y.value)
	{
		alert("Пожалуйста, введите top_right_y меньше, чем bottom_left_y");
